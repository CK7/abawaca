...
class ClusterWriter {
public:
	ClusterWriter(const char* _out_dir, const ScafDpData& _scaf_db) : out_dir(_out_dir), scaf_db(_scaf_db) 		{}
...
protected:
	...
	void		write_scaffold_stats(const ClusterData& clustering_db, const set<size_t>& scafs, const set<size_t>& raw_dps, const char* out_file) const;
...
public:
	ClusterEsomWriter(const char* _out_dir, const ScafDpData& _scaf_db) : ClusterWriter(_out_dir, _scaf_db)		{}
//	void 		write(const ClusterData& clustering_db, const set<size_t>& scafs, const set<size_t>& raw_dps, const char* cluster_name) const;
protected:
